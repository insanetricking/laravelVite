...
<head>
    ...
    <title>{{ env('APP_NAME', 'TestVite') }}</title>
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="w-full md:max-w-4xl mx-auto flex flex-wrap items-center justify-between mt-0 py-3">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-100 md:bg-transparent z-20"
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    @guest
                        <li class="mr-3">
                            <a class="inline-block py-2 px-4 text-gray-900 @if ($current_route === 'auth.login') font-bold @endif no-underline"
                                href="{{ route('auth.login') }}">Authorization</a>
                        </li>
                        <li class="mr-3">
                            <a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-2 px-4 @if ($current_route === 'auth.register') font-bold @endif"
                                href="{{ route('auth.register') }}">Registration</a>
                        </li>
                    @endguest

                    @auth
                        <li class="mr-3">
                            <a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-2 px-4 @if ($current_route === 'profile') font-bold @endif"
    ...
    <div class="container w-full md:max-w-3xl mx-auto py-20">
        ...
        @if (session('error'))
            <div class="w-full bg-red-400 text-white rounded-lg py-5 px-8 mb-10">
                {{ session('error') }}
            </div>
        @endif
